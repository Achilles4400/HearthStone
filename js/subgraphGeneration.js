function generateSubgraph(array) {

    d3.selectAll("svg").remove();

    d3.select("#sizeByHealth").on("click", sizeByHealth);
    d3.select("#SizeByAttack").on("click", sizeByAttack);
    d3.select("#sizeByCost").on("click", sizeByCost);
    d3.select("#sizeByWeight").on("click", sizeByWeight);
